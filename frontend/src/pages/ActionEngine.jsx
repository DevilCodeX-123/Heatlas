  ...
  return (
    <div className="action-engine-container">
          ...
          {step === 3 && (
            <div className="step-content fade-in" style={{textAlign: 'center', padding: '40px 0'}}>
              ...
              <p style={{color: 'var(--text-secondary)', maxWidth: '400px', margin: '0 auto'}}>
                We have processed your home profile. Review the Impact Projection and Contextual Insights generated by Heatlas AI on the right panel.
              </p>
            </div>
          )}
      ...
      <div className="impact-panel">
        ...
        <div className="insight-card">
          <Zap size={16} />
          <div>{aiResult ? aiResult.insight2 : "Your solar and energy efficiency potential will appear here once analyzed by Heatlas AI."}</div>
        </div>
        ...
        <div className="ai-box">
          <div className="ai-header">
            ...
            <div>
              <div className="ai-title">Heatlas AI Terminal</div>
